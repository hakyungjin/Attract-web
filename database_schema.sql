...
VALUES 
  ('스타터', 100, 0, 1100, false, 1),
  ('베이직', 300, 30, 3300, false, 2),
  ('프리미엄', 500, 100, 5500, true, 3),
...
-- 새 유저 가입 시 자동으로 public.users에 행 추가
...
-- 완료
-- ============================================
-- 이 스키마는 Attract 앱의 모든 기능을 지원합니다.
-- 실행 방법: Supabase SQL Editor에서 전체 내용을 복사하여 실행
